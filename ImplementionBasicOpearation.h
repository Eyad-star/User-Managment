...
namespace BasicOperation
{
    ...
    {
        string NameFile = "D:\\ProjectUsers\\DateUsers.txt";
        ...
        string LineUserInfo = ProccessText::ConvertStructToLine(InfoAccounts);
        ToolFile::SaveOneAccountToFile(LineUserInfo, NameFile);
        Security::BackUpInfoUsers(LineUserInfo, "D:\\ProjectUsers\\DataUserBackUp.txt");
